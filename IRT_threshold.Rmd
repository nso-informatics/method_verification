...
* Comparison data from for value near the screening thresholds was used to calculate regression equations
...
plot(co.deming, x.lab = "Old", y.lab = "New", main=paste(params$analyte, "Filtered Method Comparision"))
```
...
plot(fs.deming, x.lab = "Old", y.lab = "New", main=paste(params$analyte, "Filtered Method Comparision"))
```
